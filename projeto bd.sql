...
--
-- Dumping events for database 'aula5'
--

--
-- Dumping routines for database 'aula5'
--
/*!50003 DROP PROCEDURE IF EXISTS `novoaluno` */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `novoaluno`(mat_aluno INTEGER, cod_curso INTEGER, dat_nasc DATE, tot_cred INTEGER, mgp DOUBLE, nom_alun VARCHAR (60),  email VARCHAR (30))
    DETERMINISTIC
begin
...
/*!50003 DROP PROCEDURE IF EXISTS `repetecont` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `repetecont`(limite tinyint unsigned)
begin
declare cont int;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `segundowhile` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `segundowhile`(limite tinyint unsigned)
begin
declare cont int;
declare result Varchar(50);
set cont = 1;
...
-- Dump completed on 2021-05-31 22:27:00
